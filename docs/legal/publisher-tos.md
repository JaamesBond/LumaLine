...
may decline accounts where eligibility cannot be established.
...
- **Earnings accrue now; payouts are not yet live.** As you serve verified views
  (and, where supported, clicks), earnings **accrue** to your ledger. However,
  **real payouts do not begin until a later "go-live" milestone.** Until go-live,
  any balance you see is **informational only**.
- **Accrual is not a guarantee of payment.** An accrued or "provisional" balance
  is not money owed until it has cleared (see §6) and payouts are live, and is
  always subject to clawback for invalid traffic, error correction, or breach of
  these Terms.
...
You may stop participating at any time (see §9).
...
- You may request closure of your account and deletion of your data as described
  ...
  required by law (e.g. ledger entries for accounting).
