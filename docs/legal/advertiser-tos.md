...
minimum (US$0.50) are not individually charged. Such cleared amounts are tracked
...
split will apply to click revenue. The split is computed in integer micro-USD.
...
to you by LumaLine in the 12 months preceding the claim** (or US$500, whichever
